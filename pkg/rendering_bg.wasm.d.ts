...
export const _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h10a71d19c9e33e16: (a: number, b: number, c: number) => void;
export const _dyn_core__ops__function__FnMut__A_B___Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h63cc7f5dca4d5f9e: (a: number, b: number, c: number, d: number) => void;
export const _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hfbc43dea63685ec8: (a: number, b: number) => void;
export const wasm_bindgen__convert__closures__invoke1_mut__h01364c59c6664238: (a: number, b: number, c: number) => void;
export const wasm_bindgen__convert__closures__invoke0_mut__h7347b8ca95b04c6a: (a: number, b: number) => void;
export const wasm_bindgen__convert__closures__invoke1_mut__h3af26bf551f1fcd6: (a: number, b: number, c: number) => void;
export const _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h906d77c030a93521: (a: number, b: number, c: number) => void;
